package com.github.jgzl.common.handler;
...
import com.github.jgzl.common.model.OperateLog;

import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;

/**
 * 注解@within(com.github.jgzl.common.annotation.LogRecord)
 * 表示拦截含有这个注解的类中所有方法
 * 注解@annotation(com.github.jgzl.common.annotation.LogRecord)
 * 表示拦截含有这个注解的方法
...
//    private final Processor processor;
	 ...
	 */
//    @Pointcut(value = "@annotation(com.github.jgzl.common.annotation.LogRecord)")
	@Pointcut(value = "execution(public * com.github.jgzl.*.controller.*.*(..))")
