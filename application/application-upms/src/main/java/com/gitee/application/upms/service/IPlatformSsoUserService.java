 ...
 * @since 2020-01-12
 */
public interface IPlatformSsoUserService extends IService<PlatformSsoUser> {
  /**
   * 通过用户名查找用户信息（用户名唯一主键）
   * @param platformSsoUser
   * @return
   */
  UserInfoDTO findUserInfo(com.gitee.common.upms.entity.PlatformSsoUser platformSsoUser);
   ...
   * @return boolean
   */
  Boolean deleteUserById(com.gitee.common.upms.entity.PlatformSsoUser sysUser);
