...
public class OauthClientController {
	 ...
	 */
	@PutMapping
	public ResponseEntity<Result> update(@Valid @RequestBody SsoOauthClientDetailsVO vo) {
	 ...
	 */
	@PostMapping
	public ResponseEntity<Result> add(@Validated(Add.class) @RequestBody SsoOauthClientDetailsVO vo) {
