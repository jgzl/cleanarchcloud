package com.github.jgzl.common.boot.log.aspect;
...
import com.github.jgzl.common.boot.log.util.SysLogUtil;
...
public class SysLogAspect {
	...
	public void doAfterReturning(JoinPoint joinPoint, Object ret) {
		tryCatch((ex) -> {
			SysLog sysLogAnnotation = SysLogUtil.getTargetAnnotation(joinPoint);
	...
	public void recordLog(JoinPoint joinPoint) {
		tryCatch((val) -> {
			...
			sysLog.setTenantId(tenantEnvironment.tenantId());
			String controllerMethodDescription = SysLogUtil.getDescription(sysLogAnnotation);
