...
import com.github.jgzl.common.cache.annotation.RedisParam;
    ...
    public String generate(String prefix, String delimiter, ProceedingJoinPoint pjp) {
        ...
        for (Object arg : args) {
            ...
            for (Field field : fields) {
                ...
                final Object value = ReflectUtil.getFieldValue(arg, StrUtil.blankToDefault(annotation.name(), field.getName()));
