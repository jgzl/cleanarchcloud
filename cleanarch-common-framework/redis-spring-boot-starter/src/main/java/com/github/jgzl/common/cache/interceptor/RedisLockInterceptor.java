...
import com.github.jgzl.common.cache.annotation.RedisLock;
import com.github.jgzl.common.core.exception.CheckedException;
import com.github.jgzl.common.core.exception.RedisLockException;
...
public class RedisLockInterceptor {
    ...
    private String parseDefaultKey(String key, Method method, Object[] args, ProceedingJoinPoint point) {
        ...
        final String jsonText = JSONUtil.toJsonStr(keyMap) + key;
        //使用MD5生成位移key
