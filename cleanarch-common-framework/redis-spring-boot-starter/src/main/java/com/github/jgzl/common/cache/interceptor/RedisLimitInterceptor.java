...
import com.github.jgzl.common.cache.annotation.RedisLimit;
...
public class RedisLimitInterceptor {
    ...
    @Pointcut("@annotation(com.github.jgzl.common.cache.annotation.RedisLimit)")
    ...
    private String parseDefaultKey(String key, boolean useArgs, Method method, ProceedingJoinPoint point) {
        ...
        //key表达式
        key = StrUtil.isEmpty(key) ? "" : "_" + key;
        //使用MD5生成位移key
        return MD5.create().digestHex(JSONUtil.toJsonStr(keyMap) + key).toUpperCase();
    }
