...
import com.github.jgzl.common.security.exception.*;
 ...
 */
@Slf4j
public class ExtendWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new ExtendOauth2Exception(e.getMessage(), e.getOAuth2ErrorCode()),
