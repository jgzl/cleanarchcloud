...
import com.github.jgzl.common.security.exception.UnauthorizedException;
...
public class ExtendLocalResourceServerTokenServices implements ResourceServerTokenServices {
	...
	public OAuth2Authentication loadAuthentication(String accessToken)
		...
		if (!(oAuth2Authentication.getPrincipal() instanceof ExtendUser)) {
