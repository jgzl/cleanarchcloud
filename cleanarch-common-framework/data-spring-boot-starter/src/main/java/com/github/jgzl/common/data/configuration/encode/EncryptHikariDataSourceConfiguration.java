package com.github.jgzl.common.data.configuration.encode;
...
public class EncryptHikariDataSourceConfiguration {
    ...
    private static final String DEFAULT_PUB_KEY = "DEFAULT_PUB_KEY";
    ...
    public HikariDataSource dataSource(DataSourceProperties properties,
        ...
        final String pubKey = StringUtils.blankToDefault(extProperties.getPubKey(), DEFAULT_PUB_KEY);
