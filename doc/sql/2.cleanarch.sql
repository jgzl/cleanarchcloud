...
-- ----------------------------
BEGIN;
INSERT INTO `sys_route_conf`(`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (1, '开发工具模块', 'cleanarch-tools', '[{\"args\": {\"_genkey_0\": \"/tools/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-tools', 0, NULL, '2019-10-16 16:44:41', '2021-12-08 11:38:39', '0');
INSERT INTO `sys_route_conf`(`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (2, '定时任务模块', 'cleanarch-xxl-job', '[{\"args\": {\"_genkey_0\": \"/job/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-xxl-job', 0, NULL, '2019-10-16 16:44:41', '2021-12-08 11:38:41', '0');
INSERT INTO `sys_route_conf`(`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (3, '分布式事务模块', 'cleanarch-tx-manager', '[{\"args\": {\"_genkey_0\": \"/tx/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-tx-manager', 0, NULL, '2019-10-16 16:44:41', '2021-12-08 11:38:45', '0');
INSERT INTO `sys_route_conf`(`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (4, '监控管理模块', 'cleanarch-monitor', '[{\"args\": {\"_genkey_0\": \"/monitor/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-monitor', 0, NULL, '2019-10-16 16:44:41', '2021-12-08 11:38:48', '0');
...
INSERT INTO `sys_route_conf`(`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (13, '工作流模块', 'cleanarch-oa-platform', '[{\"args\": {\"_genkey_0\": \"/act/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-oa-platform', 0, NULL, '2019-10-16 16:44:41', '2021-12-08 11:38:31', '0');
INSERT INTO `sys_route_conf`(`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (14, '工作流ws模块', 'cleanarch-oa-platform-ws', '[{\"args\": {\"_genkey_0\": \"/act/ws/**\"}, \"name\": \"Path\"}]', '[]', 'lb:ws://cleanarch-oa-platform', 100, NULL, '2019-10-16 16:44:41', '2021-12-08 11:38:33', '0');
INSERT INTO `sys_route_conf`(`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (15, '微信公众号管理', 'cleanarch-mp-platform', '[{\"args\": {\"_genkey_0\": \"/mp/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-mp-platform', 0, NULL, '2019-10-16 16:44:41', '2021-12-08 11:38:52', '0');
INSERT INTO `sys_route_conf`(`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (16, '支付管理模块', 'cleanarch-pay-platform', '[{\"args\": {\"_genkey_0\": \"/pay/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-pay-platform', 0, NULL, '2019-10-16 16:44:41', '2021-12-08 11:38:55', '0');
COMMIT;
