...
-- ----------------------------
BEGIN;
INSERT INTO `cleanarch`.`sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (1, '监控管理模块', 'cleanarch-monitor', '[{\"args\": {\"_genkey_0\": \"/monitor/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-monitor', 0, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:48', '0');
INSERT INTO `cleanarch`.`sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (2, '分布式事务模块', 'cleanarch-tx-manager', '[{\"args\": {\"_genkey_0\": \"/tx/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-tx-manager', 0, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:51', '0');
INSERT INTO `cleanarch`.`sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (11, '认证中心模块', 'cleanarch-oauth', '[{\"args\": {\"_genkey_0\": \"/oauth/**\"}, \"name\": \"Path\"}]', '[{\"args\": {}, \"name\": \"ValidateCodeGatewayFilter\"}, {\"args\": {}, \"name\": \"PasswordDecoderFilter\"}]', 'lb://cleanarch-oauth', 0, NULL, '2019-10-16 16:44:41', '2021-12-08 11:38:28', '0');
...
INSERT INTO `cleanarch`.`sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (13, '开发工具模块', 'cleanarch-tools', '[{\"args\": {\"_genkey_0\": \"/tools/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-tools', 0, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:17', '0');
INSERT INTO `cleanarch`.`sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (14, '工作流模块', 'cleanarch-workflow', '[{\"args\": {\"_genkey_0\": \"/workflow/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-workflow', 0, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:34', '0');
INSERT INTO `cleanarch`.`sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (15, '工作流ws模块', 'cleanarch-workflow-ws', '[{\"args\": {\"_genkey_0\": \"/workflow/ws/**\"}, \"name\": \"Path\"}]', '[]', 'lb:ws://cleanarch-workflow', 10, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:36', '0');
INSERT INTO `cleanarch`.`sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (16, '微信公众号管理', 'cleanarch-mp-platform', '[{\"args\": {\"_genkey_0\": \"/mp/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-mp-platform', 0, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:38', '0');
INSERT INTO `cleanarch`.`sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (17, '支付管理模块', 'cleanarch-pay-platform', '[{\"args\": {\"_genkey_0\": \"/pay/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-pay-platform', 0, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:43', '0');
COMMIT;
