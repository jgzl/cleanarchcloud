...
-- ----------------------------
BEGIN;
INSERT INTO `sys_oauth_client_details` (`id`, `client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`, `del_flag`, `tenant_id`) VALUES (1, 'app', NULL, 'app', 'server', 'password,refresh_token,authorization_code,client_credentials,implicit', 'https://www.baidu.com', NULL, 43200, 2592001, '{\"enc_flag\":\"1\",\"captcha_flag\":\"1\"}', 'true', '0', 1);
INSERT INTO `sys_oauth_client_details` (`id`, `client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`, `del_flag`, `tenant_id`) VALUES (2, 'upms', NULL, 'upms', 'server', 'password,refresh_token,authorization_code,client_credentials,implicit', NULL, NULL, NULL, NULL, '{\"enc_flag\":\"1\",\"captcha_flag\":\"1\"}', 'true', '0', 1);
INSERT INTO `sys_oauth_client_details` (`id`, `client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`, `del_flag`, `tenant_id`) VALUES (3, 'tools', NULL, 'tools', 'server', 'password,refresh_token,authorization_code,client_credentials,implicit', NULL, NULL, NULL, NULL, '{\"enc_flag\":\"1\",\"captcha_flag\":\"1\"}', 'true', '0', 1);
INSERT INTO `sys_oauth_client_details` (`id`, `client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`, `del_flag`, `tenant_id`) VALUES (4, 'workflow', NULL, 'workflow', 'server', 'password,refresh_token,authorization_code,client_credentials,implicit', NULL, NULL, NULL, NULL, '{\"enc_flag\":\"1\",\"captcha_flag\":\"1\"}', 'true', '0', 1);
INSERT INTO `sys_oauth_client_details` (`id`, `client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`, `del_flag`, `tenant_id`) VALUES (5, 'pay', NULL, 'pay', 'server', 'password,refresh_token,authorization_code,client_credentials,implicit', NULL, NULL, NULL, NULL, '{\"enc_flag\":\"1\",\"captcha_flag\":\"1\"}', 'true', '0', 1);
INSERT INTO `sys_oauth_client_details` (`id`, `client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`, `del_flag`, `tenant_id`) VALUES (6, 'mp', NULL, 'mp', 'server', 'password,refresh_token,authorization_code,client_credentials,implicit', NULL, NULL, NULL, NULL, '{\"enc_flag\":\"1\",\"captcha_flag\":\"1\"}', 'true', '0', 1);
INSERT INTO `sys_oauth_client_details` (`id`, `client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`, `del_flag`, `tenant_id`) VALUES (7, 'sso1', NULL, 'sso1', 'server', 'password,refresh_token,authorization_code,client_credentials', 'http://localhost:8101/sso/login,http://127.0.0.1:8101/sso/login', NULL, NULL, NULL, '{\"enc_flag\":\"1\",\"captcha_flag\":\"1\"}', 'false', '0', 1);
INSERT INTO `sys_oauth_client_details` (`id`, `client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`, `del_flag`, `tenant_id`) VALUES (8, 'sso2', NULL, 'sso2', 'server', 'password,refresh_token,authorization_code,client_credentials', 'http://localhost:8102/sso/login,http://127.0.0.1:8102/sso/login', NULL, NULL, NULL, '{\"enc_flag\":\"1\",\"captcha_flag\":\"1\"}', 'false', '0', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (1, '监控管理模块', 'cleanarch-monitor', '[{\"args\": {\"_genkey_0\": \"/monitor/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-monitor', 0, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:48', '0');
INSERT INTO `sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (2, '分布式事务模块', 'cleanarch-tx-manager', '[{\"args\": {\"_genkey_0\": \"/tx/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-tx-manager', 0, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:51', '0');
INSERT INTO `sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (11, '认证中心模块', 'cleanarch-oauth', '[{\"args\": {\"_genkey_0\": \"/oauth/**\"}, \"name\": \"Path\"}]', '[{\"args\": {}, \"name\": \"ValidateCodeGatewayFilter\"}, {\"args\": {}, \"name\": \"PasswordDecoderFilter\"}]', 'lb://cleanarch-oauth', 0, NULL, '2019-10-16 16:44:41', '2021-12-08 11:38:28', '0');
INSERT INTO `sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (12, '用户中心模块', 'cleanarch-upms-server', '[{\"args\": {\"_genkey_0\": \"/upms/**\"}, \"name\": \"Path\"}]', '[{\"args\": {\"key-resolver\": \"#{@remoteAddrKeyResolver}\", \"redis-rate-limiter.burstCapacity\": \"1000\", \"redis-rate-limiter.replenishRate\": \"1000\"}, \"name\": \"RequestRateLimiter\"}]', 'lb://cleanarch-upms-server', 0, NULL, '2019-10-16 16:44:41', '2021-12-08 11:38:30', '0');
INSERT INTO `sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (13, '开发工具模块', 'cleanarch-tools', '[{\"args\": {\"_genkey_0\": \"/tools/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-tools', 0, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:17', '0');
INSERT INTO `sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (14, '工作流模块', 'cleanarch-workflow', '[{\"args\": {\"_genkey_0\": \"/workflow/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-workflow', 0, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:34', '0');
INSERT INTO `sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (15, '工作流ws模块', 'cleanarch-workflow-ws', '[{\"args\": {\"_genkey_0\": \"/workflow/ws/**\"}, \"name\": \"Path\"}]', '[]', 'lb:ws://cleanarch-workflow', 10, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:36', '0');
INSERT INTO `sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (16, '微信公众号管理', 'cleanarch-mp-platform', '[{\"args\": {\"_genkey_0\": \"/mp/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-mp-platform', 0, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:38', '0');
INSERT INTO `sys_route_conf` (`id`, `route_name`, `route_id`, `predicates`, `filters`, `uri`, `order`, `metadata`, `create_time`, `update_time`, `del_flag`) VALUES (17, '支付管理模块', 'cleanarch-pay-platform', '[{\"args\": {\"_genkey_0\": \"/pay/**\"}, \"name\": \"Path\"}]', '[]', 'lb://cleanarch-pay-platform', 0, NULL, '2019-10-16 16:44:41', '2021-12-11 08:43:43', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 'admin', '$2a$10$IVzj1Wd.ZQdOIWdb1htQjexU94uoNeuk1crlQ9ExVupPi0Iy1uv.C', '', '17034642888', '/admin/sys-file/lihaifeng/c5a85e0770cd4fe78bc14b63b3bd05ae.jpg', 1, '2018-04-20 07:15:18', '2019-11-02 22:12:11', '0', '0', 'o_0FT0uyg_H1vVy2H0JpSwlVGhWQ', 'oBxPy5E-v82xWGsfzZVzkD3wEX64', NULL, 'log4j', '2303656', 1);
COMMIT;
