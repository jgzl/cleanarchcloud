...
import com.gitee.common.core.base.Ref;
import com.gitee.common.core.config.CoreProperties;
import com.gitee.common.core.system.ProcessExitEvent;
...
public class ThreadPool {
  ...
  public static void initSystem() {
    System = new ThreadPool("bsf.threadPool.system", ThreadPoolProperties.getThreadPoolMinSize(),
  ...
  public <T> void parallelFor(String taskName, int parallelCount, List<T> array,
      final com.gitee.common.core.base.Callable.Action1<T> action) {
    checkHealth();
   ...
   * @param <T>
   */
  public <T> void parallelFor2(String taskName, int parallelCount, List<T> array,
      final com.gitee.common.core.base.Callable.Action1<T> action) {
    checkHealth();
    threadMonitor.hook().run(taskName, () -> {
      var parallelCount2 = parallelCount;
