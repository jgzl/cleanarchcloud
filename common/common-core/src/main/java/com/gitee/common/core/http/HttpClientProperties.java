...
public class HttpClientProperties {
    ...
    public static boolean tcpNoDelay() {
        return PropertyUtils.getPropertyCache("bsf.httpclient.tcpNoDelay",
    ...
    public static int maxTotal() {
        return PropertyUtils.getPropertyCache("bsf.httpclient.maxTotal",
    ...
    public static int defaultMaxPerRoute() {
        return PropertyUtils.getPropertyCache("bsf.httpclient.defaultMaxPerRoute",
    ...
    public static int validateAfterInactivity() {
        return PropertyUtils.getPropertyCache("bsf.httpclient.validateAfterInactivity",
    ...
    public static int connectTimeout() {
        return PropertyUtils.getPropertyCache("bsf.httpclient.connectTimeout",
    ...
    public static int socketTimeout() {
        return PropertyUtils.getPropertyCache("bsf.httpclient.socketTimeout",
    ...
    public static int connectionRequestTimeout() {
        return PropertyUtils.getPropertyCache("bsf.httpclient.connectionRequestTimeout",
    ...
    public static boolean connectionManagerShared() {
        return PropertyUtils.getPropertyCache("bsf.httpclient.connectionManagerShared",
    ...
    public static int evictIdleConnectionsTime() {
        return PropertyUtils.getPropertyCache("bsf.httpclient.evictIdleConnectionsTime",
    ...
    public static boolean isEvictExpiredConnections() {
        return PropertyUtils.getPropertyCache("bsf.httpclient.isEvictExpiredConnections",
    ...
    public static int connectionTimeToLive() {
        return PropertyUtils.getPropertyCache("bsf.httpclient.connectionTimeToLive",
    ...
    public static int retryCount() {
        return PropertyUtils.getPropertyCache("bsf.httpclient.retryCount",
