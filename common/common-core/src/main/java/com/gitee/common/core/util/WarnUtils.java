  ...
  public static void notify(String alarm_type, String title, String content, boolean isNow) {
    ...
    if (clazz != null) {
      ...
      if (bean != null) {
        if (isNow) {
          ReflectionUtils
              .callMethodWithParams(bean, "notifynow", new String[] {alarm_type, title, content}, String.class,
                  String.class, String.class);
        } else {
          ReflectionUtils.callMethodWithParams(bean, "notify", new String[] {alarm_type, title, content}, String.class,
              String.class, String.class);
        }
      }
    }
