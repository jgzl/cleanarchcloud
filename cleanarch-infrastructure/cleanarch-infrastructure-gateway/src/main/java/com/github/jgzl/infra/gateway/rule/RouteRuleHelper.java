...
import static com.github.jgzl.infra.gateway.rule.GatewayRule.Constants.GATEWAY_RULE_ROUTE;
...
public class RouteRuleHelper {
    ...
    public List<RouteRule> query() {
        ...
        for (RouteDefinition routeDefinition : routeDefinitions) {
            ...
            rule.setName(StringUtils.blankToDefault(routeDefinition.getUri().getHost(), rule.getUri().replace("lb:ws://", "").replace("lb:wss://", "")));
