...
import com.github.jgzl.infra.gateway.dataobject.GatewayRoute;
...
public class DynamicRouteInit {
	...
	public void initRoute() {
		try {
			...
			log.info("初始化网关路由完成");
			//开户监听，实现动态
			configService.addListener(GatewayConstants.CONFIG_DATA_ID_DYNAMIC_ROUTES, nacosProperties.getGroup(), new Listener() {
				@Override
