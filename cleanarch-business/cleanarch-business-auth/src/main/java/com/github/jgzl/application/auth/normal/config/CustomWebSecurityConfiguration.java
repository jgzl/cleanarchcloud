...
import com.github.jgzl.application.auth.sms.configurer.SmsCodeAuthenticationSecurityConfiguration;
import com.github.jgzl.application.auth.normal.filter.CustomUsernamePasswordAuthenticationFilter;
import com.github.jgzl.application.auth.normal.handler.*;
import com.github.jgzl.application.auth.mobile.configurer.MobileTokenAuthenticationSecurityConfiguration;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ExpressionUrlAuthorizationConfigurer<HttpSecurity>.ExpressionInterceptUrlRegistry registry =
                http
                        ...
                        .formLogin().loginPage(PathConstants.LOGIN_URL)
                        .loginProcessingUrl(PathConstants.LOGIN_FORM_URL)
