package com.github.jgzl.application.auth.mobile.filter;

import com.github.jgzl.application.auth.core.PathConstants;
import com.github.jgzl.application.auth.mobile.token.MobileTokenAuthenticationToken;
...
public class MobileTokenAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public MobileTokenAuthenticationFilter() {
        // 定义一个指定路径的手机号登录前缀
        super(new AntPathRequestMatcher(PathConstants.OAUTH_MOBILE, HttpMethod.POST.name()));
    }
