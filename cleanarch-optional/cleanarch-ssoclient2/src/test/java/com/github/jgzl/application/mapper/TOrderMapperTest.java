...
import com.github.jgzl.application.SsoClient2Application;
...
@SpringBootTest(classes = SsoClient2Application.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
