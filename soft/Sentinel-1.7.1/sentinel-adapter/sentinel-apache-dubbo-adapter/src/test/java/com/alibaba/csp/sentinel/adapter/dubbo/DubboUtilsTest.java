...
public class DubboUtilsTest {
	...
	public void testGetResourceName() throws NoSuchMethodException {
		...
		assertEquals("com.alibaba.csp.sentinel.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)",
				resourceName);
	}
	...
	public void testGetResourceNameWithGroupAndVersion() throws NoSuchMethodException {
		...
		assertEquals(
				"com.alibaba.csp.sentinel.adapter.dubbo.provider.DemoService:1.0.0:grp1:sayHello(java.lang.String,int)",
				resourceNameUseGroupAndVersion);
	}
	...
	public void testGetResourceNameWithPrefix() throws NoSuchMethodException {
		...
		assertEquals(
				"dubbo:provider:com.alibaba.csp.sentinel.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)",
				resourceName);
		resourceName = DubboUtils.getResourceName(invoker, invocation, DubboConfig.getDubboConsumerPrefix());
		assertEquals(
				"dubbo:consumer:com.alibaba.csp.sentinel.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)",
				resourceName);
		...
		assertEquals(
				"my:dubbo:provider:com.alibaba.csp.sentinel.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)",
				resourceName);
		resourceName = DubboUtils.getResourceName(invoker, invocation, DubboConfig.getDubboConsumerPrefix());
		assertEquals(
				"my:dubbo:consumer:com.alibaba.csp.sentinel.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)",
				resourceName);
	}
}
