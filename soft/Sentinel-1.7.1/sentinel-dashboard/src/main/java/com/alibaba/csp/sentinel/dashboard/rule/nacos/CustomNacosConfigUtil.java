 ...
 * @since 1.4.0
 */
public final class CustomNacosConfigUtil {
	...
	public static final String GATEWAY_FLOW_RULE_ID_POSTFIX = "-gateway-flow-rules";
	 ...
	 * @param postfix  eg.CustomNacosConfigUtil.FLOW_DATA_ID_POSTFIX
	...
	public static <T> List<T> getRuleEntities4Nacos(ConfigService configService, String appName, String postfix,
		...
		//去nacos注册中心获取配置
		String rules = configService.getConfig(genDataId(appName, postfix), CustomNacosConfigUtil.GROUP_ID, 3000);
	...
	public static <T> void setRuleString2Nacos(ConfigService configService, String app, String postfix, List<T> rules,
		...
		configService.publishConfig(
				dataId,
				CustomNacosConfigUtil.GROUP_ID,
	 ...
	 * @author:smlz
	 * @param appName 微服务名称
	 * @param postfix 规则后缀 eg.CustomNacosConfigUtil.FLOW_DATA_ID_POSTFIX
	 * @return:
	 * @exception:
