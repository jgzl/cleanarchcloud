...
app.controller('SentinelClusterAppAssignManageController',
    ['$scope', '$stateParams', 'ngDialog',
      ...
      function ($scope, $stateParams, ngDialog, MachineService,
        ...
        $scope.removeFromServerList = () => {
          ...
          if (chosenServer.belongToApp || chosenServer.machineId.indexOf('@')
              !== -1) {
        ...
        $scope.saveAndApplyAssign = () => {
          ...
          ClusterStateService.applyClusterFullAssignOfApp($scope.app,
            ...
            if (data.code === 0 && data.data) {
              ...
              if (failedClientSet.length === 0 && failedServerSet.length
                ...
                alert(
                    '推送完毕。token server 失败列表：' + JSON.stringify(failedServerSet)
                    +
