 ...
 */
angular.module('sentinelDashboardApp').controller('AuthorityRuleController',
    ['$scope', '$stateParams', 'AuthorityRuleService', 'ngDialog',
      'MachineService',
      function ($scope, $stateParams, AuthorityRuleService, ngDialog,
        ...
        $scope.deleteRule = function (ruleEntity) {
          ...
          $scope.confirmDialog = {
            ...
            attention: '资源名: ' + ruleEntity.rule.resource + ', 流控应用: '
                + ruleEntity.rule.limitApp +
