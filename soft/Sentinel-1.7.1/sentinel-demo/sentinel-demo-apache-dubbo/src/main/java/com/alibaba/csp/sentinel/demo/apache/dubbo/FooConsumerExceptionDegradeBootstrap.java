...
public class FooConsumerExceptionDegradeBootstrap {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        try {
            ...
            CompletableFuture<String> completableFuture = RpcContext.getContext()
                .asyncCall(() -> service.exceptionTest(false, true));
        ...
        for (int i = 0; i < 10; i++) {
            try {
                CompletableFuture<String> result = RpcContext.getContext()
                    .asyncCall(() -> service.exceptionTest(false, true));
