...
public class EnvoySentinelRuleConverterTest {
	...
	public void testConvertToSentinelFlowRules() {
		...
		FlowRule r1 = rules.stream()
				...
				.findAny()
				.orElseThrow(
						() -> new AssertionError("the converted rule does not exist, expected key: " + expectedK1));
		...
		FlowRule r2 = rules.stream()
				...
				.findAny()
				.orElseThrow(
						() -> new AssertionError("the converted rule does not exist, expected key: " + expectedK2));
