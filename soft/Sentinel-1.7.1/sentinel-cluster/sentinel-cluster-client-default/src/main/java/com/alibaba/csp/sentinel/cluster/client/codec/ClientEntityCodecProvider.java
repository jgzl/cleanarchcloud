...
public final class ClientEntityCodecProvider {
    ...
    private static void resolveInstance() {
        ...
        if (writer == null) {
            ...
            RecordLog.info(
                "[ClientEntityCodecProvider] Request entity writer resolved: " + requestEntityWriter.getClass()
                    .getCanonicalName());
        }
        ...
        if (decoder == null) {
            ...
            RecordLog.info(
                "[ClientEntityCodecProvider] Response entity decoder resolved: " + responseEntityDecoder.getClass()
                    .getCanonicalName());
        }
    }
